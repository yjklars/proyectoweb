...
<body class="text-light" style="background-color:#18181C">
    ...
    <div class="container-fluid pt-2 pb-5" style="background-color:#121212">
            ...
            <nav class="navbar navbar-dark navbar-expand-lg p-4">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbar2">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link active" href="panel-de-control-usuario.php">USUARIOS</a> 
                            </li>
                            <li class="nav-item">
        ...
        <div class="container pb-3 px-5">
            <form action="conexion/update-usuario.php" method="POST" class="needs-validation border border-5 bg-secondary-subtle" novalidate data-bs-theme="dark">
                ...
                <div class="row mt-4 text-center">
                    <div class="col">
                        <p1>Para <strong>editar</strong> llene los campos necesarios a continuación.</p1>
                    </div>
                </div>
                ...
                <div class="row mt-4 justify-content-center">
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control" name="clave" value="<?php echo $row['CLAVE'];?>" required>
                    </div>
                </div>
                <div class="row mt-4 justify-content-center">
                    <div class="col-4">
                ...
                <div class="row mt-4 justify-content-center">
                    <div class="col-4">
                        ...
                        <select name="adm" id="adm" class="form-select" required>
                ...
                <div class="row mt-4 mb-5 justify-content-center text-center">
                    <div class="col-4">
                        <a href="panel-de-control-usuario.php" class="btn btn-danger me-3">Cancelar</a>
